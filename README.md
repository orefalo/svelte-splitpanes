...
When a maintainer wish to publish a new release, he should do the follwing, **in this specific order**: 0. Merge all the relevant changes to master, and make sure that all Github actions checks are passed, and the auto-generated docs are fine.
