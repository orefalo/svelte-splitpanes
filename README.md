...
You may use to command below to generate the demo site locally.
...
Follow this steps to publish the package to npm. Obviously special privileges are required to perform this action.
