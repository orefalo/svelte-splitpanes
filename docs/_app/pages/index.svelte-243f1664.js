import{S as ee,i as te,s as se,P as he,e as S,t as P,k as b,w as R,c as z,a as k,h as E,d as p,m as d,x as N,g as m,J as c,y as T,q as I,o as A,B as L,b as F,O as V,l as ke,Q as Fe,R as Ye,T as Xe,v as Kt,U as qt,V as Ft,W as ss,F as ls,f as q,X as Pt,L as ns,M as rs,N as as,n as Et,p as yt,Y as is,Z as fs,D as ps,_ as os,$ as kt,j as Ve,a0 as $s,a1 as es,a2 as ts,a3 as Gt}from"../chunks/vendor-e09f8588.js";import{S as ie,P as Y}from"../chunks/Pane-57e3e9bd.js";function us(i){let e,l,t,s,r,a;return{c(){e=S("span"),l=P(`1
			`),t=S("br"),s=b(),r=S("em"),a=P("I have a min height of 20% & max height of 70%"),this.h()},l(n){e=z(n,"SPAN",{});var f=k(e);l=E(f,`1
			`),t=z(f,"BR",{}),s=d(f),r=z(f,"EM",{class:!0});var $=k(r);a=E($,"I have a min height of 20% & max height of 70%"),$.forEach(p),f.forEach(p),this.h()},h(){F(r,"class","specs")},m(n,f){m(n,e,f),c(e,l),c(e,t),c(e,s),c(e,r),c(r,a)},p:V,d(n){n&&p(e)}}}function ms(i){let e,l;return{c(){e=S("span"),l=P("2")},l(t){e=z(t,"SPAN",{});var s=k(e);l=E(s,"2"),s.forEach(p)},m(t,s){m(t,e,s),c(e,l)},p:V,d(t){t&&p(e)}}}function cs(i){let e,l,t,s,r,a;return{c(){e=S("span"),l=P(`3

			`),t=S("br"),s=b(),r=S("em"),a=P("I have a max height of 70%"),this.h()},l(n){e=z(n,"SPAN",{});var f=k(e);l=E(f,`3

			`),t=z(f,"BR",{}),s=d(f),r=z(f,"EM",{class:!0});var $=k(r);a=E($,"I have a max height of 70%"),$.forEach(p),f.forEach(p),this.h()},h(){F(r,"class","specs")},m(n,f){m(n,e,f),c(e,l),c(e,t),c(e,s),c(e,r),c(r,a)},p:V,d(n){n&&p(e)}}}function hs(i){let e,l,t,s,r,a;return e=new Y({props:{minSize:"20",maxSize:"70",$$slots:{default:[us]},$$scope:{ctx:i}}}),t=new Y({props:{$$slots:{default:[ms]},$$scope:{ctx:i}}}),r=new Y({props:{maxSize:"70",$$slots:{default:[cs]},$$scope:{ctx:i}}}),{c(){R(e.$$.fragment),l=b(),R(t.$$.fragment),s=b(),R(r.$$.fragment)},l(n){N(e.$$.fragment,n),l=d(n),N(t.$$.fragment,n),s=d(n),N(r.$$.fragment,n)},m(n,f){T(e,n,f),m(n,l,f),T(t,n,f),m(n,s,f),T(r,n,f),a=!0},p(n,f){const $={};f&2&&($.$$scope={dirty:f,ctx:n}),e.$set($);const o={};f&2&&(o.$$scope={dirty:f,ctx:n}),t.$set(o);const h={};f&2&&(h.$$scope={dirty:f,ctx:n}),r.$set(h)},i(n){a||(I(e.$$.fragment,n),I(t.$$.fragment,n),I(r.$$.fragment,n),a=!0)},o(n){A(e.$$.fragment,n),A(t.$$.fragment,n),A(r.$$.fragment,n),a=!1},d(n){L(e,n),n&&p(l),L(t,n),n&&p(s),L(r,n)}}}function _s(i){let e,l,t,s,r,a,n,f=!1+"",$,o,h,g,_,w,M;return g=new ie({props:{class:"default-theme",horizontal:!0,style:"height: 400px",$$slots:{default:[hs]},$$scope:{ctx:i}}}),w=new he({props:{code:i[0]}}),{c(){e=S("h2"),l=P("Horizontal layout, push other panes, min & max use, doubleclick"),t=b(),s=S("p"),r=P("You can double click a splitter to maximize the next pane!"),a=S("br"),n=P(`
...
<Splitpanes class="default-theme" style="height: 400px">
    ...
    {/each}
</Splitpanes>`]}class Ys extends ee{constructor(e){super();te(this,e,Vs,Os,se,{})}}function Xs(i){let e,l,t,s,r;return{c(){e=Ye("defs"),l=Ye("filter"),t=Ye("feGaussianBlur"),s=b(),r=Ye("circle"),this.h()},l(a){e=Xe(a,"defs",{});var n=k(e);l=Xe(n,"filter",{id:!0,x:!0,y:!0});var f=k(l);t=Xe(f,"feGaussianBlur",{in:!0,stdDeviation:!0}),k(t).forEach(p),f.forEach(p),n.forEach(p),s=d(a),r=Xe(a,"circle",{cx:!0,cy:!0,r:!0,opacity:!0,filter:!0,class:!0}),k(r).forEach(p),this.h()},h(){F(t,"in","SourceGraphic"),F(t,"stdDeviation",i[2]),F(l,"id","f1"),F(l,"x","0"),F(l,"y","0"),F(r,"cx",i[0]),F(r,"cy",i[1]),F(r,"r",i[3]),F(r,"opacity",i[4]),F(r,"filter","url(#f1)"),F(r,"class","svelte-1lfi58h")},m(a,n){m(a,e,n),c(e,l),c(l,t),m(a,s,n),m(a,r,n)},p(a,[n]){n&4&&F(t,"stdDeviation",a[2]),n&1&&F(r,"cx",a[0]),n&2&&F(r,"cy",a[1]),n&8&&F(r,"r",a[3]),n&16&&F(r,"opacity",a[4])},i:V,o:V,d(a){a&&p(e),a&&p(s),a&&p(r)}}}function qs(i,e,l){let t,s,{x:r,y:a,sizeIn:n,size:f,speed:$,rippleBlur:o,opacityIn:h}=e;Kt(()=>{_.set(0),g.set(f)});const g=qt(n,{duration:$}),_=qt(h,{duration:$+$*2.5,easing:ss});return Ft(i,g,w=>l(3,t=w)),Ft(i,_,w=>l(4,s=w)),i.$$set=w=>{"x"in w&&l(0,r=w.x),"y"in w&&l(1,a=w.y),"sizeIn"in w&&l(7,n=w.sizeIn),"size"in w&&l(8,f=w.size),"speed"in w&&l(9,$=w.speed),"rippleBlur"in w&&l(2,o=w.rippleBlur),"opacityIn"in w&&l(10,h=w.opacityIn)},[r,a,o,t,s,g,_,n,f,$,h]}class Fs extends ee{constructor(e){super();te(this,e,qs,Xs,se,{x:0,y:1,sizeIn:7,size:8,speed:9,rippleBlur:2,opacityIn:10})}}function Ut(i,e,l){const t=i.slice();return t[46]=e[l],t[48]=l,t}function Wt(i){let e,l;return e=new Fs({props:{x:i[46].x,y:i[46].y,size:i[46].size,speed:i[1],sizeIn:i[11],opacityIn:i[12],rippleBlur:i[0]}}),{c(){R(e.$$.fragment)},l(t){N(e.$$.fragment,t)},m(t,s){T(e,t,s),l=!0},p(t,s){const r={};s[0]&262144&&(r.x=t[46].x),s[0]&262144&&(r.y=t[46].y),s[0]&262144&&(r.size=t[46].size),s[0]&2&&(r.speed=t[1]),s[0]&2048&&(r.sizeIn=t[11]),s[0]&4096&&(r.opacityIn=t[12]),s[0]&1&&(r.rippleBlur=t[0]),e.$set(r)},i(t){l||(I(e.$$.fragment,t),l=!0)},o(t){A(e.$$.fragment,t),l=!1},d(t){L(e,t)}}}function Gs(i){let e,l,t,s,r,a,n;const f=i[28].default,$=ls(f,i,i[27],null);let o=i[18],h=[];for(let _=0;_<o.length;_+=1)h[_]=Wt(Ut(i,o,_));const g=_=>A(h[_],1,1,()=>{h[_]=null});return{c(){e=S("button"),l=S("span"),$&&$.c(),t=b(),s=Ye("svg");for(let _=0;_<h.length;_+=1)h[_].c();this.h()},l(_){e=z(_,"BUTTON",{style:!0,class:!0});var w=k(e);l=z(w,"SPAN",{class:!0});var M=k(l);$&&$.l(M),M.forEach(p),t=d(w),s=Xe(w,"svg",{class:!0});var v=k(s);for(let x=0;x<h.length;x+=1)h[x].l(v);v.forEach(p),w.forEach(p),this.h()},h(){F(l,"class","svelte-c42aw5"),F(s,"class","svelte-c42aw5"),q(e,"--color",i[2]),q(e,"--font-size",i[3]),q(e,"--bg-color",i[4]),q(e,"--bg-hover",i[5]),q(e,"--bg-active",i[6]),q(e,"--radius",i[8]),q(e,"--ripple",i[7]),q(e,"--height",i[9]+"px"),q(e,"--width",i[10]+"px"),q(e,"--shadow",i[19][i[13]]),q(e,"--shadow-h",i[19][i[14]]),q(e,"--shadow-a",i[19][i[15]]),F(e,"class","svelte-c42aw5")},m(_,w){m(_,e,w),c(e,l),$&&$.m(l,null),c(e,t),c(e,s);for(let M=0;M<h.length;M+=1)h[M].m(s,null);i[30](e),r=!0,a||(n=[Pt(e,"click",i[29]),Pt(e,"touchstart",i[31]),Pt(e,"mousedown",i[32])],a=!0)},p(_,w){if($&&$.p&&(!r||w[0]&134217728)&&ns($,f,_,_[27],r?as(f,_[27],w,null):rs(_[27]),null),w[0]&268291){o=_[18];let M;for(M=0;M<o.length;M+=1){const v=Ut(_,o,M);h[M]?(h[M].p(v,w),I(h[M],1)):(h[M]=Wt(v),h[M].c(),I(h[M],1),h[M].m(s,null))}for(Et(),M=o.length;M<h.length;M+=1)g(M);yt()}(!r||w[0]&4)&&q(e,"--color",_[2]),(!r||w[0]&8)&&q(e,"--font-size",_[3]),(!r||w[0]&16)&&q(e,"--bg-color",_[4]),(!r||w[0]&32)&&q(e,"--bg-hover",_[5]),(!r||w[0]&64)&&q(e,"--bg-active",_[6]),(!r||w[0]&256)&&q(e,"--radius",_[8]),(!r||w[0]&128)&&q(e,"--ripple",_[7]),(!r||w[0]&512)&&q(e,"--height",_[9]+"px"),(!r||w[0]&1024)&&q(e,"--width",_[10]+"px"),(!r||w[0]&8192)&&q(e,"--shadow",_[19][_[13]]),(!r||w[0]&16384)&&q(e,"--shadow-h",_[19][_[14]]),(!r||w[0]&32768)&&q(e,"--shadow-a",_[19][_[15]])},i(_){if(!r){I($,_);for(let w=0;w<o.length;w+=1)I(h[w]);r=!0}},o(_){A($,_),h=h.filter(Boolean);for(let w=0;w<h.length;w+=1)A(h[w]);r=!1},d(_){_&&p(e),$&&$.d(_),Fe(h,_),i[30](null),a=!1,is(n)}}}function Us(i,e,l){let t,s=V,r=()=>(s(),s=fs(J,H=>l(18,t=H)),J);i.$$.on_destroy.push(()=>s());let{$$slots:a={},$$scope:n}=e,{rippleBlur:f=0,speed:$=900,color:o="#fff",fontSize:h=".875rem",bgColor:g="74, 64, 212",bgHover:_=g,bgActive:w=g,rippleColor:M="#838de7",round:v="0.2rem",height:x=36,width:y=140,sizeIn:D=20,opacityIn:B=.5,shadow:O=5,shadowHover:Z=5,shadowActive:W=2}=e,le={none:"none",1:"0 0 0 1px rgba(0, 0, 0, 0.05)",2:"0 1px 2px 0 rgba(0, 0, 0, 0.05)",3:"0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06)",4:"0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)",5:"0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)",6:"0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)",7:"0 25px 50px -12px rgba(0, 0, 0, 0.25)"};function we(){const H=ps([]);return{subscribe:H.subscribe,add:be=>{H.update(Pe=>[...Pe,be])},clear:()=>{H.update(be=>[])}}}const J=we();r();let _e,ne,K,oe,$e,G,ue,re,fe,me,Q,ce,ge={x:50,y:50};const pe=()=>{clearTimeout(ce),ce=setTimeout(()=>{J.clear()},$+$*2)};let ae;function Se(H,be){be=="touch"?(ae=!0,J.add({x:H.pageX-me,y:H.pageY-fe,size:Q})):(ae||J.add({x:H.clientX-me,y:H.clientY-fe,size:Q}),ae=!1),pe()}Kt(()=>{l(21,K=ne.offsetWidth),l(22,oe=ne.offsetHeight),_e=ne.getBoundingClientRect(),fe=_e.y,me=_e.x});function ze(H){os.call(this,i,H)}function C(H){kt[H?"unshift":"push"](()=>{ne=H,l(17,ne)})}const U=H=>Se(H.touches[0],"touch"),ve=H=>Se(H,"click");return i.$$set=H=>{"rippleBlur"in H&&l(0,f=H.rippleBlur),"speed"in H&&l(1,$=H.speed),"color"in H&&l(2,o=H.color),"fontSize"in H&&l(3,h=H.fontSize),"bgColor"in H&&l(4,g=H.bgColor),"bgHover"in H&&l(5,_=H.bgHover),"bgActive"in H&&l(6,w=H.bgActive),"rippleColor"in H&&l(7,M=H.rippleColor),"round"in H&&l(8,v=H.round),"height"in H&&l(9,x=H.height),"width"in H&&l(10,y=H.width),"sizeIn"in H&&l(11,D=H.sizeIn),"opacityIn"in H&&l(12,B=H.opacityIn),"shadow"in H&&l(13,O=H.shadow),"shadowHover"in H&&l(14,Z=H.shadowHover),"shadowActive"in H&&l(15,W=H.shadowActive),"$$scope"in H&&l(27,n=H.$$scope)},i.$$.update=()=>{i.$$.dirty[0]&132120576&&(l(23,$e=Math.abs(K/2-ge.x)),l(24,G=Math.abs(oe/2-ge.y)),l(25,ue=K/2+$e),l(26,re=oe/2+G),Q=Math.sqrt(Math.pow(ue,2.2)+Math.pow(re,2.2)))},[f,$,o,h,g,_,w,M,v,x,y,D,B,O,Z,W,J,ne,t,le,Se,K,oe,$e,G,ue,re,n,a,ze,C,U,ve]}class qe extends ee{constructor(e){super();te(this,e,Us,Gs,se,{rippleBlur:0,speed:1,color:2,fontSize:3,bgColor:4,bgHover:5,bgActive:6,rippleColor:7,round:8,height:9,width:10,sizeIn:11,opacityIn:12,shadow:13,shadowHover:14,shadowActive:15,ripples:16},null,[-1,-1])}get ripples(){return this.$$.ctx[16]}}function Jt(i,e,l){const t=i.slice();return t[4]=e[l],t[6]=l,t}function Ws(i){let e;return{c(){e=P("+ ADD PANE")},l(l){e=E(l,"+ ADD PANE")},m(l,t){m(l,e,t)},d(l){l&&p(e)}}}function Js(i){let e;return{c(){e=P("- REMOVE PANE")},l(l){e=E(l,"- REMOVE PANE")},m(l,t){m(l,e,t)},d(l){l&&p(e)}}}function Qs(i){let e,l=i[6]+1+"",t,s;return{c(){e=S("span"),t=P(l),s=b()},l(r){e=z(r,"SPAN",{});var a=k(e);t=E(a,l),a.forEach(p),s=d(r)},m(r,a){m(r,e,a),c(e,t),m(r,s,a)},p:V,d(r){r&&p(e),r&&p(s)}}}function Qt(i){let e,l;return e=new Y({props:{minSize:"10",$$slots:{default:[Qs]},$$scope:{ctx:i}}}),{c(){R(e.$$.fragment)},l(t){N(e.$$.fragment,t)},m(t,s){T(e,t,s),l=!0},p(t,s){const r={};s&128&&(r.$$scope={dirty:s,ctx:t}),e.$set(r)},i(t){l||(I(e.$$.fragment,t),l=!0)},o(t){A(e.$$.fragment,t),l=!1},d(t){L(e,t)}}}function Zs(i){let e,l,t={length:i[0]},s=[];for(let a=0;a<t.length;a+=1)s[a]=Qt(Jt(i,t,a));const r=a=>A(s[a],1,1,()=>{s[a]=null});return{c(){for(let a=0;a<s.length;a+=1)s[a].c();e=ke()},l(a){for(let n=0;n<s.length;n+=1)s[n].l(a);e=ke()},m(a,n){for(let f=0;f<s.length;f+=1)s[f].m(a,n);m(a,e,n),l=!0},p(a,n){if(n&1){t={length:a[0]};let f;for(f=0;f<t.length;f+=1){const $=Jt(a,t,f);s[f]?(s[f].p($,n),I(s[f],1)):(s[f]=Qt($),s[f].c(),I(s[f],1),s[f].m(e.parentNode,e))}for(Et(),f=t.length;f<s.length;f+=1)r(f);yt()}},i(a){if(!l){for(let n=0;n<t.length;n+=1)I(s[n]);l=!0}},o(a){s=s.filter(Boolean);for(let n=0;n<s.length;n+=1)A(s[n]);l=!1},d(a){Fe(s,a),a&&p(e)}}}function Ks(i){let e,l,t,s,r,a,n,f,$,o,h;return s=new qe({props:{$$slots:{default:[Ws]},$$scope:{ctx:i}}}),s.$on("click",i[2]),a=new qe({props:{$$slots:{default:[Js]},$$scope:{ctx:i}}}),a.$on("click",i[3]),f=new ie({props:{class:"default-theme",style:"height: 400px",$$slots:{default:[Zs]},$$scope:{ctx:i}}}),o=new he({props:{code:i[1]}}),{c(){e=S("h2"),l=P("Adding splitters programmatically"),t=b(),R(s.$$.fragment),r=b(),R(a.$$.fragment),n=b(),R(f.$$.fragment),$=b(),R(o.$$.fragment)},l(g){e=z(g,"H2",{});var _=k(e);l=E(_,"Adding splitters programmatically"),_.forEach(p),t=d(g),N(s.$$.fragment,g),r=d(g),N(a.$$.fragment,g),n=d(g),N(f.$$.fragment,g),$=d(g),N(o.$$.fragment,g)},m(g,_){m(g,e,_),c(e,l),m(g,t,_),T(s,g,_),m(g,r,_),T(a,g,_),m(g,n,_),T(f,g,_),m(g,$,_),T(o,g,_),h=!0},p(g,[_]){const w={};_&128&&(w.$$scope={dirty:_,ctx:g}),s.$set(w);const M={};_&128&&(M.$$scope={dirty:_,ctx:g}),a.$set(M);const v={};_&129&&(v.$$scope={dirty:_,ctx:g}),f.$set(v)},i(g){h||(I(s.$$.fragment,g),I(a.$$.fragment,g),I(f.$$.fragment,g),I(o.$$.fragment,g),h=!0)},o(g){A(s.$$.fragment,g),A(a.$$.fragment,g),A(f.$$.fragment,g),A(o.$$.fragment,g),h=!1},d(g){g&&p(e),g&&p(t),L(s,g),g&&p(r),L(a,g),g&&p(n),L(f,g),g&&p($),L(o,g)}}}function el(i,e,l){let t=3;return[t,`
<script>
    let panesNumber = 3;
<\/script>    
<Button
...
<Splitpanes class="default-theme" style="height: 400px" {firstSplitter} {horizontal}>
	...
	{/each}
</Splitpanes>`,()=>{l(0,t=!t)},()=>{l(1,s=!s)}]}class ol extends ee{constructor(e){super();te(this,e,pl,fl,se,{})}}function $l(i){let e,l=i[0][0]+"",t,s;return{c(){e=S("span"),t=P(l),s=P("%")},l(r){e=z(r,"SPAN",{});var a=k(e);t=E(a,l),s=E(a,"%"),a.forEach(p)},m(r,a){m(r,e,a),c(e,t),c(e,s)},p(r,a){a&1&&l!==(l=r[0][0]+"")&&Ve(t,l)},d(r){r&&p(e)}}}function ul(i){let e,l=100-i[0][0]+"",t,s;return{c(){e=S("span"),t=P(l),s=P("%")},l(r){e=z(r,"SPAN",{});var a=k(e);t=E(a,l),s=E(a,"%"),a.forEach(p)},m(r,a){m(r,e,a),c(e,t),c(e,s)},p(r,a){a&1&&l!==(l=100-r[0][0]+"")&&Ve(t,l)},d(r){r&&p(e)}}}function ml(i){let e,l,t,s;return e=new Y({props:{size:i[0][0]+"",$$slots:{default:[$l]},$$scope:{ctx:i}}}),t=new Y({props:{size:100-i[0][0]+"",$$slots:{default:[ul]},$$scope:{ctx:i}}}),{c(){R(e.$$.fragment),l=b(),R(t.$$.fragment)},l(r){N(e.$$.fragment,r),l=d(r),N(t.$$.fragment,r)},m(r,a){T(e,r,a),m(r,l,a),T(t,r,a),s=!0},p(r,a){const n={};a&1&&(n.size=r[0][0]+""),a&9&&(n.$$scope={dirty:a,ctx:r}),e.$set(n);const f={};a&1&&(f.size=100-r[0][0]+""),a&9&&(f.$$scope={dirty:a,ctx:r}),t.$set(f)},i(r){s||(I(e.$$.fragment,r),I(t.$$.fragment,r),s=!0)},o(r){A(e.$$.fragment,r),A(t.$$.fragment,r),s=!1},d(r){L(e,r),r&&p(l),L(t,r)}}}function cl(i){let e,l,t,s,r,a,n,f,$,o,h,g,_;function w(v){i[2](v)}let M={float:!0,min:0,max:100};return i[0]!==void 0&&(M.values=i[0]),n=new $s({props:M}),kt.push(()=>es(n,"values",w)),o=new ie({props:{class:"default-theme",style:"height: 400px",$$slots:{default:[ml]},$$scope:{ctx:i}}}),g=new he({props:{code:i[1]}}),{c(){e=S("h2"),l=P("Programmatic resizing"),t=b(),s=S("p"),r=P("This example shows the programmatic way of resizing panes. And how it works both ways."),a=b(),R(n.$$.fragment),$=b(),R(o.$$.fragment),h=b(),R(g.$$.fragment)},l(v){e=z(v,"H2",{});var x=k(e);l=E(x,"Programmatic resizing"),x.forEach(p),t=d(v),s=z(v,"P",{});var y=k(s);r=E(y,"This example shows the programmatic way of resizing panes. And how it works both ways."),y.forEach(p),a=d(v),N(n.$$.fragment,v),$=d(v),N(o.$$.fragment,v),h=d(v),N(g.$$.fragment,v)},m(v,x){m(v,e,x),c(e,l),m(v,t,x),m(v,s,x),c(s,r),m(v,a,x),T(n,v,x),m(v,$,x),T(o,v,x),m(v,h,x),T(g,v,x),_=!0},p(v,[x]){const y={};!f&&x&1&&(f=!0,y.values=v[0],ts(()=>f=!1)),n.$set(y);const D={};x&9&&(D.$$scope={dirty:x,ctx:v}),o.$set(D)},i(v){_||(I(n.$$.fragment,v),I(o.$$.fragment,v),I(g.$$.fragment,v),_=!0)},o(v){A(n.$$.fragment,v),A(o.$$.fragment,v),A(g.$$.fragment,v),_=!1},d(v){v&&p(e),v&&p(t),v&&p(s),v&&p(a),L(n,v),v&&p($),L(o,v),v&&p(h),L(g,v)}}}function hl(i,e,l){let t=[50],s=`
<script>
    let value = [50, 100];
<\/script>
<Slider bind:value />
...
`,s,r,a,n,f;return{c(){e=S("div"),l=S("pre"),s=P(t),r=b(),a=S("textarea"),this.h()},l($){e=z($,"DIV",{class:!0});var o=k(e);l=z(o,"PRE",{"aria-hidden":!0,style:!0,class:!0});var h=k(l);s=E(h,t),h.forEach(p),r=d(o),a=z(o,"TEXTAREA",{style:!0,class:!0}),k(a).forEach(p),o.forEach(p),this.h()},h(){F(l,"aria-hidden","true"),q(l,"min-height",i[2]),q(l,"max-height",i[1]),F(l,"class","svelte-1gm0t61"),a.readOnly=!0,q(a,"outline","none"),F(a,"class","svelte-1gm0t61"),F(e,"class","container svelte-1gm0t61")},m($,o){m($,e,o),c(e,l),c(l,s),c(e,r),c(e,a),Gt(a,i[0]),n||(f=Pt(a,"input",i[5]),n=!0)},p($,[o]){o&1&&t!==(t=$[0]+`
`)&&Ve(s,t),o&4&&q(l,"min-height",$[2]),o&2&&q(l,"max-height",$[1]),o&1&&Gt(a,$[0])},i:V,o:V,d($){$&&p(e),n=!1,f()}}}function yl(i,e,l){let t,s,{value:r=""}=e,{minRows:a=1}=e,{maxRows:n=40}=e;const f=h=>h.split(/\r?\n/);function $(h,g){const _=f(h);return _.length=g,_.reduce(function(M,v){return M+`
`+v})}function o(){r=this.value,l(0,r),l(4,n)}return i.$$set=h=>{"value"in h&&l(0,r=h.value),"minRows"in h&&l(3,a=h.minRows),"maxRows"in h&&l(4,n=h.maxRows)},i.$$.update=()=>{i.$$.dirty&17&&l(0,r=$(r,n)),i.$$.dirty&8&&l(2,t=`${1+a*1.2}em`),i.$$.dirty&16&&l(1,s=n?`${1+n*1.2}em`:"auto")},[r,s,t,a,n,o]}class kl extends ee{constructor(e){super();te(this,e,yl,El,se,{value:0,minRows:3,maxRows:4})}}function xl(i,e,l){const t=i.slice();return t[4]=e[l],t[6]=l,t}function Il(i){let e,l=i[6]+1+"",t,s;return{c(){e=S("span"),t=P(l),s=b()},l(r){e=z(r,"SPAN",{});var a=k(e);t=E(a,l),a.forEach(p),s=d(r)},m(r,a){m(r,e,a),c(e,t),m(r,s,a)},p:V,d(r){r&&p(e),r&&p(s)}}}function Al(i){let e,l;return e=new Y({props:{minSize:"10",$$slots:{default:[Il]},$$scope:{ctx:i}}}),{c(){R(e.$$.fragment)},l(t){N(e.$$.fragment,t)},m(t,s){T(e,t,s),l=!0},p(t,s){const r={};s&128&&(r.$$scope={dirty:s,ctx:t}),e.$set(r)},i(t){l||(I(e.$$.fragment,t),l=!0)},o(t){A(e.$$.fragment,t),l=!1},d(t){L(e,t)}}}function Bl(i){let e,l,t={length:3},s=[];for(let r=0;r<t.length;r+=1)s[r]=Al(xl(i,t,r));return{c(){for(let r=0;r<s.length;r+=1)s[r].c();e=ke()},l(r){for(let a=0;a<s.length;a+=1)s[a].l(r);e=ke()},m(r,a){for(let n=0;n<s.length;n+=1)s[n].m(r,a);m(r,e,a),l=!0},p:V,i(r){if(!l){for(let a=0;a<t.length;a+=1)I(s[a]);l=!0}},o(r){s=s.filter(Boolean);for(let a=0;a<s.length;a+=1)A(s[a]);l=!1},d(r){Fe(s,r),r&&p(e)}}}function Hl(i){let e,l,t,s,r,a,n,f,$,o,h,g,_,w,M,v,x,y,D,B,O,Z,W,le,we,J,_e,ne,K,oe,$e,G,ue,re,fe,me,Q,ce,ge,pe,ae;G=new ie({props:{class:"default-theme",style:"height: 400px",$$slots:{default:[Bl]},$$scope:{ctx:i}}}),G.$on("ready",i[1]),G.$on("resize",i[1]),G.$on("resized",i[1]),G.$on("pane-click",i[1]),G.$on("pane-maximize",i[1]),G.$on("pane-add",i[1]),G.$on("pane-remove",i[1]),G.$on("splitter-click",i[1]);function Se(C){i[3](C)}let ze={minRows:4,maxRows:40};return i[0]!==void 0&&(ze.value=i[0]),Q=new kl({props:ze}),kt.push(()=>es(Q,"value",Se)),pe=new he({props:{code:i[2]}}),{c(){e=S("h2"),l=P("Listening to emitted events"),t=b(),s=S("p"),r=P("Here is the list of events that are emitted from splitpanes:"),a=b(),n=S("ul"),f=S("li"),$=P("ready has no parameter and fires when splitpanes is ready"),o=b(),h=S("li"),g=P(`resize fires while resizing (on mousemove/touchmove) and returns an array of all the panes objects with their
		...
		only emitted if dragging did not occur between mousedown and mouseup.`),xe.forEach(p),H.forEach(p),$e=d(C),N(G.$$.fragment,C),ue=d(C),re=z(C,"P",{});var de=k(re);fe=E(de,"Try resizing panes and check the logs bellow."),de.forEach(p),me=d(C),N(Q.$$.fragment,C),ge=d(C),N(pe.$$.fragment,C)},m(C,U){m(C,e,U),c(e,l),m(C,t,U),m(C,s,U),c(s,r),m(C,a,U),m(C,n,U),c(n,f),c(f,$),c(n,o),c(n,h),c(h,g),c(n,_),c(n,w),c(w,M),c(n,v),c(n,x),c(x,y),c(n,D),c(n,B),c(B,O),c(n,Z),c(n,W),c(W,le),c(n,we),c(n,J),c(J,_e),c(n,ne),c(n,K),c(K,oe),m(C,$e,U),T(G,C,U),m(C,ue,U),m(C,re,U),c(re,fe),m(C,me,U),T(Q,C,U),m(C,ge,U),T(pe,C,U),ae=!0},p(C,[U]){const ve={};U&128&&(ve.$$scope={dirty:U,ctx:C}),G.$set(ve);const H={};!ce&&U&1&&(ce=!0,H.value=C[0],ts(()=>ce=!1)),Q.$set(H)},i(C){ae||(I(G.$$.fragment,C),I(Q.$$.fragment,C),I(pe.$$.fragment,C),ae=!0)},o(C){A(G.$$.fragment,C),A(Q.$$.fragment,C),A(pe.$$.fragment,C),ae=!1},d(C){C&&p(e),C&&p(t),C&&p(s),C&&p(a),C&&p(n),C&&p($e),L(G,C),C&&p(ue),C&&p(re),C&&p(me),L(Q,C),C&&p(ge),L(pe,C)}}}function Rl(i,e,l){let t="// Event name: Event params   (Last event at the top)";function s(n){n.detail?l(0,t=n.type+" "+JSON.stringify(n.detail)+`
`+t):l(0,t=n.type+`
`+t)}let r=`
<script>
...
`]}class Xl extends ee{constructor(e){super();te(this,e,Yl,Vl,se,{})}}function ql(i){let e,l;return{c(){e=S("p"),l=P("MenuBar")},l(t){e=z(t,"P",{});var s=k(e);l=E(s,"MenuBar"),s.forEach(p)},m(t,s){m(t,e,s),c(e,l)},p:V,d(t){t&&p(e)}}}function Fl(i){let e,l;return{c(){e=S("p"),l=P("ToolBar")},l(t){e=z(t,"P",{});var s=k(e);l=E(s,"ToolBar"),s.forEach(p)},m(t,s){m(t,e,s),c(e,l)},p:V,d(t){t&&p(e)}}}function Gl(i){let e,l,t,s;return{c(){e=S("p"),l=P("Folder"),t=S("br"),s=P(`
                Try those -->`)},l(r){e=z(r,"P",{});var a=k(e);l=E(a,"Folder"),t=z(a,"BR",{}),s=E(a,`
                Try those -->`),a.forEach(p)},m(r,a){m(r,e,a),c(e,l),c(e,t),c(e,s)},p:V,d(r){r&&p(e)}}}function Ul(i){let e,l;return{c(){e=S("p"),l=P("Views")},l(t){e=z(t,"P",{});var s=k(e);l=E(s,"Views"),s.forEach(p)},m(t,s){m(t,e,s),c(e,l)},p:V,d(t){t&&p(e)}}}function Wl(i){let e,l;return{c(){e=S("p"),l=P("Details")},l(t){e=z(t,"P",{});var s=k(e);l=E(s,"Details"),s.forEach(p)},m(t,s){m(t,e,s),c(e,l)},p:V,d(t){t&&p(e)}}}function Jl(i){let e,l,t,s,r,a;return e=new Y({props:{$$slots:{default:[Gl]},$$scope:{ctx:i}}}),t=new Y({props:{$$slots:{default:[Ul]},$$scope:{ctx:i}}}),r=new Y({props:{$$slots:{default:[Wl]},$$scope:{ctx:i}}}),{c(){R(e.$$.fragment),l=b(),R(t.$$.fragment),s=b(),R(r.$$.fragment)},l(n){N(e.$$.fragment,n),l=d(n),N(t.$$.fragment,n),s=d(n),N(r.$$.fragment,n)},m(n,f){T(e,n,f),m(n,l,f),T(t,n,f),m(n,s,f),T(r,n,f),a=!0},p(n,f){const $={};f&2&&($.$$scope={dirty:f,ctx:n}),e.$set($);const o={};f&2&&(o.$$scope={dirty:f,ctx:n}),t.$set(o);const h={};f&2&&(h.$$scope={dirty:f,ctx:n}),r.$set(h)},i(n){a||(I(e.$$.fragment,n),I(t.$$.fragment,n),I(r.$$.fragment,n),a=!0)},o(n){A(e.$$.fragment,n),A(t.$$.fragment,n),A(r.$$.fragment,n),a=!1},d(n){L(e,n),n&&p(l),L(t,n),n&&p(s),L(r,n)}}}function Ql(i){let e,l;return e=new ie({props:{theme:"modern-theme",$$slots:{default:[Jl]},$$scope:{ctx:i}}}),{c(){R(e.$$.fragment)},l(t){N(e.$$.fragment,t)},m(t,s){T(e,t,s),l=!0},p(t,s){const r={};s&2&&(r.$$scope={dirty:s,ctx:t}),e.$set(r)},i(t){l||(I(e.$$.fragment,t),l=!0)},o(t){A(e.$$.fragment,t),l=!1},d(t){L(e,t)}}}function Zl(i){let e,l;return{c(){e=S("p"),l=P("statusbar")},l(t){e=z(t,"P",{});var s=k(e);l=E(s,"statusbar"),s.forEach(p)},m(t,s){m(t,e,s),c(e,l)},p:V,d(t){t&&p(e)}}}function Kl(i){let e,l,t,s,r,a,n,f;return e=new Y({props:{size:"6",minSize:"6",maxSize:"6",$$slots:{default:[ql]},$$scope:{ctx:i}}}),t=new Y({props:{size:"6",minSize:"6",maxSize:"6",$$slots:{default:[Fl]},$$scope:{ctx:i}}}),r=new Y({props:{$$slots:{default:[Ql]},$$scope:{ctx:i}}}),n=new Y({props:{size:"6",minSize:"6",maxSize:"6",$$slots:{default:[Zl]},$$scope:{ctx:i}}}),{c(){R(e.$$.fragment),l=b(),R(t.$$.fragment),s=b(),R(r.$$.fragment),a=b(),R(n.$$.fragment)},l($){N(e.$$.fragment,$),l=d($),N(t.$$.fragment,$),s=d($),N(r.$$.fragment,$),a=d($),N(n.$$.fragment,$)},m($,o){T(e,$,o),m($,l,o),T(t,$,o),m($,s,o),T(r,$,o),m($,a,o),T(n,$,o),f=!0},p($,o){const h={};o&2&&(h.$$scope={dirty:o,ctx:$}),e.$set(h);const g={};o&2&&(g.$$scope={dirty:o,ctx:$}),t.$set(g);const _={};o&2&&(_.$$scope={dirty:o,ctx:$}),r.$set(_);const w={};o&2&&(w.$$scope={dirty:o,ctx:$}),n.$set(w)},i($){f||(I(e.$$.fragment,$),I(t.$$.fragment,$),I(r.$$.fragment,$),I(n.$$.fragment,$),f=!0)},o($){A(e.$$.fragment,$),A(t.$$.fragment,$),A(r.$$.fragment,$),A(n.$$.fragment,$),f=!1},d($){L(e,$),$&&p(l),L(t,$),$&&p(s),L(r,$),$&&p(a),L(n,$)}}}function en(i){let e,l,t,s,r,a,n,f,$,o;return n=new ie({props:{theme:"no-splitter",horizontal:!0,style:"height: 400px",dblClickSplitter:!1,$$slots:{default:[Kl]},$$scope:{ctx:i}}}),$=new he({props:{code:i[0]}}),{c(){e=S("h2"),l=P("Styling Splitters - Modern"),t=b(),s=S("p"),r=P("This examples brings few new concepts over the previous one, however it tries to formalize how CSS styling could be applied to panes in order to achieve the desired layout."),a=b(),R(n.$$.fragment),f=b(),R($.$$.fragment)},l(h){e=z(h,"H2",{});var g=k(e);l=E(g,"Styling Splitters - Modern"),g.forEach(p),t=d(h),s=z(h,"P",{});var _=k(s);r=E(_,"This examples brings few new concepts over the previous one, however it tries to formalize how CSS styling could be applied to panes in order to achieve the desired layout."),_.forEach(p),a=d(h),N(n.$$.fragment,h),f=d(h),N($.$$.fragment,h)},m(h,g){m(h,e,g),c(e,l),m(h,t,g),m(h,s,g),c(s,r),m(h,a,g),T(n,h,g),m(h,f,g),T($,h,g),o=!0},p(h,[g]){const _={};g&2&&(_.$$scope={dirty:g,ctx:h}),n.$set(_)},i(h){o||(I(n.$$.fragment,h),I($.$$.fragment,h),o=!0)},o(h){A(n.$$.fragment,h),A($.$$.fragment,h),o=!1},d(h){h&&p(e),h&&p(t),h&&p(s),h&&p(a),L(n,h),h&&p(f),L($,h)}}}function tn(i){return[`
...
<style global lang="scss">:global(.splitpanes) {
  background-color: #f8f8f8;
}
