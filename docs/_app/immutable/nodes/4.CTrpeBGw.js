...
`,st={code:J,highlightedHTML:tt,component:G};function nt(r){let s,l="Change orientation & first splitter",t,n,a=`When changing direction, all the panes current width or height will flip to adapt to the new
  layout.`,p,e,o=`Showing the first splitter is an option which allows user to double click the splitter to maximize
  the next pane.
  <br/>
  The first splitter does not allow to resize the next pane.`,m,h,u;return h=new D({props:{example:st}}),{c(){s=k("h2"),s.textContent=l,t=g(),n=k("p"),n.textContent=a,p=g(),e=k("p"),e.innerHTML=o,m=g(),d(h.$$.fragment)},l(i){s=v(i,"H2",{"data-svelte-h":!0}),B(s)!=="svelte-y44nzx"&&(s.textContent=l),t=_(i),n=v(i,"P",{"data-svelte-h":!0}),B(n)!=="svelte-udf81i"&&(n.textContent=a),p=_(i),e=v(i,"P",{"data-svelte-h":!0}),B(e)!=="svelte-1mdr6d1"&&(e.innerHTML=o),m=_(i),x(h.$$.fragment,i)},m(i,$){f(i,s,$),f(i,t,$),f(i,n,$),f(i,p,$),f(i,e,$),f(i,m,$),z(h,i,$),u=!0},p:b,i(i){u||(j(h.$$.fragment,i),u=!0)},o(i){S(h.$$.fragment,i),u=!1},d(i){i&&(c(s),c(t),c(n),c(p),c(e),c(m)),w(h,i)}}}class it extends C{constructor(s){super(),M(this,s,null,nt,V,{})}}export{it as component,rt as universal};
