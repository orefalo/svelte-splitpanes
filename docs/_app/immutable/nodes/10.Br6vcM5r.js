...
`,G={code:D,highlightedHTML:F,component:B};function J(i){let a,l="Programmatic resizing",t,e,p=`This example shows the programmatic way of resizing panes with two-way data biding. And how it
  works both ways.
  <br/>
  Changing programmatically the size one pane, will shrink/expand the other panes that have no specified
  size, as you can see in the example.`,r,o,s;return o=new O({props:{example:G}}),{c(){a=x("h2"),a.textContent=l,t=v(),e=x("p"),e.innerHTML=p,r=v(),h(o.$$.fragment)},l(n){a=b(n,"H2",{"data-svelte-h":!0}),P(a)!=="svelte-fwbuix"&&(a.textContent=l),t=w(n),e=b(n,"P",{"data-svelte-h":!0}),P(e)!=="svelte-22zitk"&&(e.innerHTML=p),r=w(n),f(o.$$.fragment,n)},m(n,c){g(n,a,c),g(n,t,c),g(n,e,c),g(n,r,c),$(o,n,c),s=!0},p:H,i(n){s||(d(o.$$.fragment,n),s=!0)},o(n){_(o.$$.fragment,n),s=!1},d(n){n&&(u(a),u(t),u(e),u(r)),j(o,n)}}}class ns extends k{constructor(a){super(),M(this,a,null,J,A,{})}}export{ns as component,as as universal};
