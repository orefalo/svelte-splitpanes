import{S as T,i as L,s as A,P as d,Q as b,R as v,n as S,o as P,U as z,a as w,f as I,j as o,g as m,e as j,b as _,I as q,K as H,X as y,d as E,Y as k,k as x}from"../chunks/external.D6DzbhJx.js";import{E as N}from"../chunks/ExampleArea.CG0T9HS5.js";import{S as Y,P as M}from"../chunks/svelte-splitpanes.DVC8h31e.js";const O=!0,ss=Object.freeze(Object.defineProperty({__proto__:null,prerender:O},Symbol.toStringTag,{value:"Module"}));function R(i){let s,e=`1
...
`,G={code:D,highlightedHTML:F,component:X};function J(i){let s,e="Horizontal layout, push other panes, min & max use, doubleclick",a,n,p,h,t,c="false",u,$,g,f,C;return f=new N({props:{example:G}}),{c(){s=j("h2"),s.textContent=e,a=w(),n=j("p"),p=y("You can double click a splitter to maximize the next pane!"),h=j("br"),t=y(`
