import{S as A,i as C,s as L,e as d,X as q,a as v,b as j,d as b,Y as N,g as m,f as _,h as k,W as x,j as g,k as y,a9 as H,F as I,Z as U,K as w,C as X,a1 as B,P as S,Q as T,I as M,R,a2 as F,n as $,o as z,U as E,_ as K,D as O,$ as Q}from"../chunks/external.DQiJWucQ.js";import{E as V}from"../chunks/ExampleArea.DbC3uosY.js";import{S as W,P as Y}from"../chunks/svelte-splitpanes.HHNcmiRR.js";const Z=!0,ds=Object.freeze(Object.defineProperty({__proto__:null,prerender:Z},Symbol.toStringTag,{value:"Module"}));function G(i){let s,t,n=i[0]+`
`,l,a,e,o,f;return{c(){s=d("div"),t=d("pre"),l=q(n),a=v(),e=d("textarea"),this.h()},l(h){s=j(h,"DIV",{class:!0});var c=b(s);t=j(c,"PRE",{"aria-hidden":!0,style:!0,class:!0});var p=b(t);l=N(p,n),p.forEach(m),a=_(c),e=j(c,"TEXTAREA",{style:!0,class:!0}),b(e).forEach(m),c.forEach(m),this.h()},h(){k(t,"aria-hidden","true"),x(t,"min-height",i[2]),x(t,"max-height",i[1]),k(t,"class","svelte-1cx9x18"),e.readOnly=!0,x(e,"outline","none"),k(e,"class","svelte-1cx9x18"),k(s,"class","container svelte-1cx9x18")},m(h,c){g(h,s,c),y(s,t),y(t,l),y(s,a),y(s,e),H(e,i[0]),o||(f=I(e,"input",i[5]),o=!0)},p(h,[c]){c&1&&n!==(n=h[0]+`
