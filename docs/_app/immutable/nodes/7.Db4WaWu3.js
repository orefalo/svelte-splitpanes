import{S as A,i as C,s as L,e as d,X as N,a as v,b as j,d as k,Y as q,g as m,f as _,h as b,W as x,j as g,k as y,a9 as H,F as I,Z as U,K as w,C as X,a1 as B,P as S,Q as T,I as M,R,a2 as F,n as $,o as z,U as E,_ as K,D as O,$ as Q}from"../chunks/external.TakMDKee.js";import{E as V}from"../chunks/ExampleArea.DZmCBYAi.js";import{S as W,P as Y}from"../chunks/svelte-splitpanes.kCkEqNgR.js";const Z=!0,ds=Object.freeze(Object.defineProperty({__proto__:null,prerender:Z},Symbol.toStringTag,{value:"Module"}));function G(p){let s,t,n=p[0]+`
`,l,a,e,o,f;return{c(){s=d("div"),t=d("pre"),l=N(n),a=v(),e=d("textarea"),this.h()},l(h){s=j(h,"DIV",{class:!0});var c=k(s);t=j(c,"PRE",{"aria-hidden":!0,style:!0,class:!0});var i=k(t);l=q(i,n),i.forEach(m),a=_(c),e=j(c,"TEXTAREA",{style:!0,class:!0}),k(e).forEach(m),c.forEach(m),this.h()},h(){b(t,"aria-hidden","true"),x(t,"min-height",p[2]),x(t,"max-height",p[1]),b(t,"class","svelte-1gm0t61"),e.readOnly=!0,x(e,"outline","none"),b(e,"class","svelte-1gm0t61"),b(s,"class","container svelte-1gm0t61")},m(h,c){g(h,s,c),y(s,t),y(t,l),y(s,a),y(s,e),H(e,p[0]),o||(f=I(e,"input",p[5]),o=!0)},p(h,[c]){c&1&&n!==(n=h[0]+`
...
`+D})}function c(){a=this.value,t(0,a),t(4,o)}return p.$$set=i=>{"value"in i&&t(0,a=i.value),"minRows"in i&&t(3,e=i.minRows),"maxRows"in i&&t(4,o=i.maxRows)},p.$$.update=()=>{p.$$.dirty&17&&t(0,a=h(a,o)),p.$$.dirty&8&&t(2,n=`${1+e*1.2}em`),p.$$.dirty&16&&t(1,l=o?`${1+o*1.2}em`:"auto")},[a,l,n,e,o,c]}class es extends A{constructor(s){super(),C(this,s,ss,G,L,{value:0,minRows:3,maxRows:4})}}function ns(p,s,t){const n=p.slice();return n[3]=s[t],n[5]=t,n}function as(p){let s,t=p[5]+1+"",n,l;return{c(){s=d("span"),n=N(t),l=v()},l(a){s=j(a,"SPAN",{});var e=k(s);n=q(e,t),e.forEach(m),l=_(a)},m(a,e){g(a,s,e),y(s,n),g(a,l,e)},p:w,d(a){a&&(m(s),m(l))}}}function ts(p){let s,t;return s=new Y({props:{minSize:10,$$slots:{default:[as]},$$scope:{ctx:p}}}),{c(){S(s.$$.fragment)},l(n){T(s.$$.fragment,n)},m(n,l){R(s,n,l),t=!0},p(n,l){const a={};l&64&&(a.$$scope={dirty:l,ctx:n}),s.$set(a)},i(n){t||($(s.$$.fragment,n),t=!0)},o(n){z(s.$$.fragment,n),t=!1},d(n){E(s,n)}}}function ls(p){let s,t,n=K({length:3}),l=[];for(let a=0;a<n.length;a+=1)l[a]=ts(ns(p,n,a));return{c(){for(let a=0;a<l.length;a+=1)l[a].c();s=O()},l(a){for(let e=0;e<l.length;e+=1)l[e].l(a);s=O()},m(a,e){for(let o=0;o<l.length;o+=1)l[o]&&l[o].m(a,e);g(a,s,e),t=!0},p:w,i(a){if(!t){for(let e=0;e<n.length;e+=1)$(l[e]);t=!0}},o(a){l=l.filter(Boolean);for(let e=0;e<l.length;e+=1)z(l[e]);t=!1},d(a){a&&m(s),Q(l,a)}}}function is(p){let s,t,n,l="Try resizing panes and check the logs bellow.",a,e,o,f;s=new W({props:{style:"height: 400px",$$slots:{default:[ls]},$$scope:{ctx:p}}}),s.$on("ready",p[1]),s.$on("resize",p[1]),s.$on("resized",p[1]),s.$on("pane-click",p[1]),s.$on("pane-maximize",p[1]),s.$on("pane-add",p[1]),s.$on("pane-remove",p[1]),s.$on("splitter-click",p[1]);function h(i){p[2](i)}let c={minRows:4,maxRows:40};return p[0]!==void 0&&(c.value=p[0]),e=new es({props:c}),X.push(()=>B(e,"value",h)),{c(){S(s.$$.fragment),t=v(),n=d("p"),n.textContent=l,a=v(),S(e.$$.fragment)},l(i){T(s.$$.fragment,i),t=_(i),n=j(i,"P",{"data-svelte-h":!0}),M(n)!=="svelte-duj1zz"&&(n.textContent=l),a=_(i),T(e.$$.fragment,i)},m(i,r){R(s,i,r),g(i,t,r),g(i,n,r),g(i,a,r),R(e,i,r),f=!0},p(i,[r]){const u={};r&64&&(u.$$scope={dirty:r,ctx:i}),s.$set(u);const P={};!o&&r&1&&(o=!0,P.value=i[0],F(()=>o=!1)),e.$set(P)},i(i){f||($(s.$$.fragment,i),$(e.$$.fragment,i),f=!0)},o(i){z(s.$$.fragment,i),z(e.$$.fragment,i),f=!1},d(i){i&&(m(t),m(n),m(a)),E(s,i),E(e,i)}}}function ps(p,s,t){let n="// Event name: Event params   (Last event at the top)";function l(e){e.detail?t(0,n=e.type+" "+JSON.stringify(e.detail)+`
`+n):t(0,n=e.type+`
`+n)}function a(e){n=e,t(0,n)}return[n,l,a]}class rs extends A{constructor(s){super(),C(this,s,ps,is,L,{})}}const os=`<script>
...
`,hs={code:os,highlightedHTML:cs,component:rs};function ms(p){let s,t="Listening to emitted events",n,l,a="Here is the list of events that are emitted from splitpanes:",e,o,f=`<li>ready has no parameter and fires when splitpanes is ready</li> <li>resize fires while resizing (on mousemove/touchmove) and returns an array of all the panes objects with their
		...
		only emitted if dragging did not occur between mousedown and mouseup.</li>`,h,c,i;return c=new V({props:{example:hs}}),{c(){s=d("h2"),s.textContent=t,n=v(),l=d("p"),l.textContent=a,e=v(),o=d("ul"),o.innerHTML=f,h=v(),S(c.$$.fragment)},l(r){s=j(r,"H2",{"data-svelte-h":!0}),M(s)!=="svelte-11dglzf"&&(s.textContent=t),n=_(r),l=j(r,"P",{"data-svelte-h":!0}),M(l)!=="svelte-1fepioh"&&(l.textContent=a),e=_(r),o=j(r,"UL",{"data-svelte-h":!0}),M(o)!=="svelte-cxrzub"&&(o.innerHTML=f),h=_(r),T(c.$$.fragment,r)},m(r,u){g(r,s,u),g(r,n,u),g(r,l,u),g(r,e,u),g(r,o,u),g(r,h,u),R(c,r,u),i=!0},p:w,i(r){i||($(c.$$.fragment,r),i=!0)},o(r){z(c.$$.fragment,r),i=!1},d(r){r&&(m(s),m(n),m(l),m(e),m(o),m(h)),E(c,r)}}}class js extends A{constructor(s){super(),C(this,s,null,ms,L,{})}}export{js as component,ds as universal};
