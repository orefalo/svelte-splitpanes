import{S as y,i as v,s as z,e as c,a as S,L as p,b as h,f as w,d as x,M as b,g as l,h as _,Z as R,j as f,k as d,I as m,H as I}from"../../../chunks/external-a6e0a43e.js";function k(g){let t,u,s,i,r,n,o;return{c(){t=c("img"),s=S(),i=c("p"),r=p(`The badge above tells the amortized size of the library after minification when using all the library features.
	`),n=c("br"),o=p(`
	...
	`),n=h(a,"BR",{}),o=b(a,`
	It is computed in the build time of the demo website, specifying how much size it really takes after the Rollup build process,
	for the client code and the server(SSR) code.`),a.forEach(l),this.h()},h(){_(t,"alt","Minified Size"),R(t.src,u=I+"/minified-size-badge.svg")||_(t,"src",u)},m(e,a){f(e,t,a),f(e,s,a),f(e,i,a),d(i,r),d(i,n),d(i,o)},p:m,i:m,o:m,d(e){e&&l(t),e&&l(s),e&&l(i)}}}class q extends y{constructor(t){super(),v(this,t,null,k,z,{})}}export{q as default};
