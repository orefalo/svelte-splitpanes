import{S as F,i as V,s as D,Q as u,R as _,T as g,n as d,o as h,V as v,a as T,f as k,j as c,g as i,e as z,L as S,b as w,d as x,M as b,k as m,I as y}from"../../../../../chunks/external-a03e8ebe.js";import{E as j}from"../../../../../chunks/ExampleArea-f8063daf.js";import{S as R,P as E}from"../../../../../chunks/svelte-splitpanes-e7a119d8.js";function q($){let t,p;return{c(){t=z("p"),p=S("MenuBar")},l(e){t=w(e,"P",{});var s=x(t);p=b(s,"MenuBar"),s.forEach(i)},m(e,s){c(e,t,s),m(t,p)},p:y,d(e){e&&i(t)}}}function A($){let t,p;return{c(){t=z("p"),p=S("ToolBar")},l(e){t=w(e,"P",{});var s=x(t);p=b(s,"ToolBar"),s.forEach(i)},m(e,s){c(e,t,s),m(t,p)},p:y,d(e){e&&i(t)}}}function H($){let t,p,e,s,a=">",f;return{c(){t=z("p"),p=S("Folder"),e=z("br"),s=S(`
